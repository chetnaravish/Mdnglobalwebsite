          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/MDNGlobalSchoolKaithal/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#f5a623] hover:text-[#1a3a6b] transition-colors">
                  <Facebook size={18} />
                </a>
                <a href="https://www.instagram.com/mdnglobalschoolktl/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#f5a623] hover:text-[#1a3a6b] transition-colors">
                  <Instagram size={18} />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="https://www.facebook.com/MDNGlobalSchoolKaithal/" target="_blank" rel="noopener noreferrer"
                ...
                <li>
                  <a href="https://www.instagram.com/mdnglobalschoolktl/?hl=en" target="_blank" rel="noopener noreferrer"
                    className="text-white/70 hover:text-[#f5a623] transition-colors flex items-center gap-3 group">
                    <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#f5a623] group-hover:text-[#1a3a6b] transition-colors shrink-0">
                      <Instagram size={15} />
                    </span>
