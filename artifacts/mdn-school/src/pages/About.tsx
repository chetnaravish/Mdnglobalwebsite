          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
              ...
              <ul className="mt-7 space-y-3">
                {[
                  'CBSE affiliated from Nursery through Class XII',
                  'Smart classrooms with interactive digital boards',
                  '10-acre green campus with sports complex',
                  'Science, Commerce & Medical / Non-Medical streams',
                  'Consistent 100% Board pass rate — 5 years running',
                  'GPS-enabled transport covering all major routes',
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-gray-700 text-sm font-medium">
                    <CheckCircle size={16} className="text-[#f5a623] shrink-0 mt-0.5" /> {item}
                  </li>
                ))}
              </ul>
            </motion.div>
            ...
            <motion.div variants={fadeRight} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 bg-[#1a3a6b] text-white rounded-2xl p-5 shadow-xl max-w-[200px]">
                ...
                <div className="text-xl font-serif font-bold mb-0.5">CBSE</div>
                <div className="text-white/70 text-xs">Affiliated & Recognised</div>
              </div>
              <div className="absolute -top-4 -right-4 bg-[#f5a623] text-[#1a3a6b] rounded-2xl p-4 shadow-xl">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <motion.div key={i}
                ...
                className="text-center p-6 bg-white/08 rounded-2xl border border-white/12 hover:bg-white/14 transition-all group"
              >
                <div className="w-10 h-10 rounded-xl bg-[#f5a623]/20 flex items-center justify-center mx-auto mb-3 group-hover:bg-[#f5a623]/35 transition-colors">
                  <s.icon size={20} className="text-[#f5a623]" />
                </div>
                <div className="text-3xl md:text-4xl font-serif font-black text-[#f5a623] mb-1">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Left — image, sized to match content */}
